...
public:
	World(
		...
		, m_scrollRatios{}, m_scrollSpeeds{}, m_scrollOffsets{}, m_cameraPosition(0, 0), m_mapSize(0, 0) {}
	...
	const Vec2&   getMapSize() const                                                { return m_mapSize; }
	void          setMapSize(const Vec2& mapSize)                                   { m_mapSize = mapSize; }
